                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('cashier.index') }}">{{ __('Cashiers') }}</a>
                        </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ url()->route('cashier.update', Crypt::encrypt($cashier->id)) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ url()->route('cashier.index') }}" class="btn btn-outline-warning">{{ __('Back') }}</a>
                        </div>
                    </form>
                </div>
            </div>
