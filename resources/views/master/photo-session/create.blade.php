                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url()->route('photo-session.index') }}">{{ __('Photo Sessions') }}</a>
                        </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ url()->route('photo-session.store') }}" method="POST">
                        @csrf
                        @method("POST")
                        ...
                        <div class="card-body">
                            <div class="row form-group mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="code" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="Enter Code">
                            ...
                            <div class="row form-group mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="start_time" name="start_time" class="form-control flatpickr-time text-start @error('start_time') is-invalid @enderror" value="{{ old('start_time') }}" placeholder="HH:MM">
                            ...
                            <div class="row form-group mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="end_time" name="end_time" class="form-control flatpickr-time text-start @error('end_time') is-invalid @enderror" value="{{ old('end_time') }}" placeholder="HH:MM">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ url()->route('photo-session.index') }}" class="btn btn-outline-warning">{{ __('Back') }}</a>
                        </div>
                    </form>
                </div>
            </div>
