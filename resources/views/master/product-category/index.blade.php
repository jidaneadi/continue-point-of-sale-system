                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url()->current() }}">{{ __('Product Categories') }}</a>
                        </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <a class="btn btn-outline-primary" href="{{ url()->route('product-category.create') }}">
                    ...
                    <div class="card-body">
                        <table id="crudProductCategory" class="table">
                            <thead>
                                <tr>
...
@push('script')
    <script>
        var datatable = $('#crudProductCategory').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url()->route('product-category.data') }}",
            columns: [
                ...
                { 
                    ...
                    render: function(data, type, row) {
                        var editUrl = "{{ route('product-category.edit', ':id') }}".replace(':id', row.id);
                        var deleteUrl = "{{ route('product-category.destroy', ':id') }}".replace(':id', row.id);
