                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url()->route('discount.index') }}">{{ __('Discounts') }}</a>
                        </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ url()->route('discount.store') }}" method="POST">
                        @csrf
                        @method("POST")
                        ...
                        <div class="card-body">
                            <div class="row form-group mb-1">
                                ...
                                <div class="col-sm-9">
                                    <select id="product" name="product" class="form-select" data-placeholder=" -- Select Product Category --">
                                        <option disabled>{{ __('-- Select Product Category --') }}</option>
                                        
                                        @foreach($products as $product)
                                            <option value="{{ $product->id }}" {{ old('product') ? "selected": "" }}>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row form-group mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="discount" name="discount" class="form-control @error('discount') is-invalid @enderror" value="{{ old('discount') }}" placeholder="Enter Discount">
                            ...
                            <div class="row form-group mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="start_date" name="start_date" class="form-control flatpickr-basic @error('start_date') is-invalid @enderror" value="{{ old('start_date') }}" placeholder="YYYY-MM-DD" />
                            ...
                            <div class="row form-group mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="end_date" name="end_date" class="form-control flatpickr-basic @error('end_date') is-invalid @enderror" value="{{ old('end_date') }}" placeholder="YYYY-MM-DD" />
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ url()->route('discount.index') }}" class="btn btn-outline-warning">{{ __('Back') }}</a>
                        </div>
                    </form>
                </div>
            </div>
