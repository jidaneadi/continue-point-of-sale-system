                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url()->current() }}">{{ __('Products') }}</a>
                        </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <a class="btn btn-outline-primary" href="{{ url()->route('product.create') }}">
    ...
    <script>
        var datatable = $('#crudProduct').DataTable({
            ...
            columns: [
                ...
                { data: 'category.name', name: 'category.name', class: 'text-center' },
                ...
                { 
                    ...
                    render: function(data, type, row) {
                        var deleteUrl = "{{ route('product.destroy', ':id') }}".replace(':id', row.id);
